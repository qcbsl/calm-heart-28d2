...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/calm-heart-28d2
```

A live public deployment of this template is available at [https://calm-heart-28d2.templates.workers.dev](https://calm-heart-28d2.templates.workers.dev)
